<?php if( !($count) )header("HTTP/1.1 404 Not Found"); ?>
    <script type="text/javascript">
    $(function(){
        $("#scroll .wrap").infinitescroll({
             loadingImg     : "<?php echo base_url('public/img/ajax-loader.gif');?>",
             navSelector    : "a#next:last",
             nextSelector   : "a#next:last",
             itemSelector   : "#scroll div.item",
             dataType       : 'html',
             path: function(index) {
                ...
                return "<?php echo base_url('home/search'); ?>" + '/' + (index-1) + '/' + "<?php echo $this->uri->segment(4, 0); ?>"
             }
        });
    });
    </script>
    <div id="main-wrap">
        <div id="main">
            ...
            <div id="content">
                <div class="white-block-box little-border-radius">
                    <div id="search-result" class="under-line medium-padding-box">
                ...
                <div id="scroll">
                    <div class="wrap white-space-clear">
                        <?php foreach($products as $key => $product):?>
                            ...
                            <?php endforeach;?>
                            <a id="next" href="<?php echo base_url('home/search') . '/' . ($this->uri->segment(3, 0) + 1) . '/' . $this->uri->segment(4, 0); ?>">next</a>
                    </div>
                </div>
